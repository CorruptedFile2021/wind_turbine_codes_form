                ...
                ft.Container(content=ft.Column(controls=[
                    ft.Row(controls=[
                        ft.Column(controls=[
                            ...
                            ft.Text(value="1.Vertical axis + Horizontal axis turbines = Our Wind Farm.",style=ft.TextThemeStyle.DISPLAY_LARGE,text_align=ft.TextAlign.CENTER),
                            ft.Text(value="2.Microwave motors for high torque.",style=ft.TextThemeStyle.DISPLAY_LARGE,text_align=ft.TextAlign.CENTER),
                            ft.Text(value="3.One real dc generator turbine in progress, could generate ~12V.",style=ft.TextThemeStyle.DISPLAY_LARGE,text_align=ft.TextAlign.CENTER),
                            ft.Text(value="4.Turbine motion recorded by AI codes for further analysis.",style=ft.TextThemeStyle.DISPLAY_LARGE,text_align=ft.TextAlign.CENTER),
                            ft.Text(value="5. 4 Turbines  mounted on a 4 x 4 feet board.",style=ft.TextThemeStyle.DISPLAY_LARGE,text_align=ft.TextAlign.CENTER),
                            ft.Text(value="6. Beautification to be complete.",style=ft.TextThemeStyle.DISPLAY_LARGE,text_align=ft.TextAlign.CENTER),
                            

                        ])
                        
                    ],alignment=ft.MainAxisAlignment.CENTER)
                ], alignment=ft.MainAxisAlignment.CENTER, expand=True),image_src="information.jpg",width=2300,image_opacity=0.4,image_fit=ft.ImageFit.FILL),
